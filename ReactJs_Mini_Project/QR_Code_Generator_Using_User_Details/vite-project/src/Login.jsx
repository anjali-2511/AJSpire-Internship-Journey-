            ...
            <div className="bg-dark vh-50 border rounded d-flex justify-content-center p-5 pt-5">
                <div className="card bg-dark ms-5 text-white border-secondary w-50 h-50 mt-5 ps-5 pe-5 m-5">
                    ...
                    <input
                        ...
                        className="form-control border-primary bg-secondary"
                    />
                    ...
                    {showOtp ? (
                        <input
                            ...
                            className="form-control border-primary bg-secondary mb-2 mt-2"
                        />
                    ) : (
                        <button
                    ...
                    <div className="d-flex justify-content-center">
                        <button
                            onClick={loged}
                            className="btn btn-dark border-secondary px-4 py-2 w-50 gap-2 mt-2">Login
